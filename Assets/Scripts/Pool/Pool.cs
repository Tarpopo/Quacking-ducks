...
namespace DefaultNamespace
{
    public class Pool:MonoBehaviour
    {
        ...
        // public GameObject Populate(GameObject prefab,bool hui = false, Vector3 position = default(Vector3),
        //     Quaternion rotation = default(Quaternion), Transform parent = null)
        // {
        //     print(prefab.name);
        //     var go = PhotonNetwork.Instantiate(prefab.name, position, rotation).transform;
        //     if (parent == null)
        //     {
        //         go.position = position;
        //         go.transform.SetParent(parentPool);
